    ...
    return (
      <div className="max-w-md mx-auto bg-white rounded-2xl shadow-lg p-8">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Demo Mode - No Email Sent</h2>
          <p className="text-gray-600 mb-6">
            In demo mode, no real email is sent to <strong>{formData.email}</strong>. 
            To receive real emails, start the backend server.
          </p>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-yellow-700">
                    <p>This is a demo. To enable real email sending, start the backend server with:</p>
                    <code className="block mt-1 bg-yellow-100 px-2 py-1 rounded text-xs">docker-compose up -d</code>
                  </div>
                </div>
              </div>
            </div>
