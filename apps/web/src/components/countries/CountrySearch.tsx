      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-xandhopp-accent focus:border-transparent"
          >
        ...
        <div ref={searchRef} className="relative">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-4 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-xandhopp-accent focus:border-transparent text-lg"
              disabled={isLoading}
            />
            <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
              {isSearching ? (
                <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-xandhopp-accent"></div>
              ) : (
