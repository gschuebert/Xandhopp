...
// Section labels will be translated using the content.countries object
...
export function CountryDetail({ country, locale, onBack }: CountryDetailProps) {
  ...
  const availableSections: ContentSection[] = ['overview', 'culture', 'demography', 'economy', 'history'].filter(
    section => getSectionContent(section as ContentSection)
  ) as ContentSection[];
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            {availableSections.map((section) => (
              ...
              >
                ...
                <span>{content.countries[section as keyof typeof content.countries]}</span>
              </button>
            ))}
          </div>
            ...
            <div className="prose prose-lg max-w-none">
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-2xl font-bold text-xandhopp-blue mb-4">
                  {content.countries[activeSection as keyof typeof content.countries]}
                </h3>
