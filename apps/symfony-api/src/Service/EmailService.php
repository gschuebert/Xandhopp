...
class EmailService
{
    ...
    public function sendVerificationEmail(string $toEmail, string $firstName, string $verificationToken): void
    {
        ...
        $email = (new Email())
            ...
            ->to($toEmail)
            ->subject('Verify your email address - Portalis')
    ...
    private function getVerificationEmailTemplate(string $firstName, string $verificationUrl): string
    {
        ...
        <body style='font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;'>
            <div style='text-align: center; margin-bottom: 30px;'>
                <h1 style='color: #2563eb;'>Portalis</h1>
            </div>
            
            <h2>Hello {$firstName}!</h2>
            
            <p>Thank you for registering with Portalis. To complete your registration, please verify your email address by clicking the button below:</p>
            ...
            <p style='font-size: 12px; color: #666;'>If you didn't create an account with Portalis, please ignore this email.</p>
        </body>
        </html>
        ";
    }
    ...
    private function getWelcomeEmailTemplate(string $firstName): string
    {
        ...
        <head>
            <meta charset='utf-8'>
            <title>Welcome to Portalis</title>
        </head>
        <body style='font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;'>
            <div style='text-align: center; margin-bottom: 30px;'>
                <h1 style='color: #2563eb;'>Portalis</h1>
            ...
            <h2>Welcome to Portalis, {$firstName}!</h2>
            ...
            <p>Thank you for joining Portalis!</p>
            
            <hr style='margin: 30px 0; border: none; border-top: 1px solid #eee;'>
            <p style='font-size: 12px; color: #666;'>This email was sent to you because you registered an account with Portalis.</p>
        </body>
        </html>
        ";
    }
